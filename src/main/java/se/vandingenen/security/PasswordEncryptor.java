...
public class PasswordEncryptor {
    // BCrypt workload to use when generating password hashes. 10-31 is a valid value.
     ...
     */
    public static boolean checkPassword (String plaintextPassword, String storedHashPassword) {
        ...
        password_verified = BCrypt.checkpw(plaintextPassword, storedHashPassword);
